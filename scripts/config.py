...
parser.add_argument('--video_time_clips', type=int, default=2)
parser.add_argument('--video_move_step', type=int, default=1)

parser.add_argument('--save_path', type=str, default='snapshot/DALA/')
