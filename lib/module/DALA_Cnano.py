...
from lib.module.ConvNeXtv2 import convnextv2_nano
...
class DALA(nn.Module):
    def __init__(self):
        ...
        self.feature_extractor = convnextv2_nano(pretrained=True)
        self.RFB1 = LightRFB(channels_in=80, channels_mid=128, channels_out=32)
        self.RFB2 = LightRFB(channels_in=160, channels_mid=128, channels_out=32)
        self.RFB3 = LightRFB(channels_in=320, channels_mid=128, channels_out=32)
    ...
    def forward(self, x):
        ...
        _, x = self.feature_extractor.forward_features(x)
